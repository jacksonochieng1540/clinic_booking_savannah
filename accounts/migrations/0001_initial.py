    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('patient', 'Patient'), ('doctor', 'Doctor'), ('admin', 'Admin'), ('staff', 'Staff')], default='patient', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('login', 'Login'), ('logout', 'Logout'), ('register', 'Register'), ('password_reset', 'Password Reset'), ('profile_update', 'Profile Update'), ('booking', 'Booking Created'), ('cancellation', 'Booking Cancelled'), ('reschedule', 'Booking Rescheduled')], max_length=20)),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=['user', 'action', 'created_at'], name='accounts_us_user_id_771d38_idx'),
        ),
    ]
