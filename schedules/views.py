...
from core.permissions import IsAdminUser, IsDoctorOrAdmin
from core.utils import generate_time_slots
from doctors.models import Doctor

from .models import WorkingHours
from .serializers import WorkingHoursListSerializer, WorkingHoursSerializer
...
class WorkingHoursListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        return WorkingHours.objects.filter(doctor=doctor, is_available=True)
